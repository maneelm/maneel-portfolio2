...
export const Navbar = ({ menuopen, setmenuopen }) => {
    ...
    return (
        <>
            <nav className={`fixed left-0 top-0 w-full z-40 transition-all duration-300 ${
                scrolled 
                    ? "bg-[rgba(0,10,15,0.9)] backdrop-blur-xl shadow-lg py-0" 
                    : "bg-[rgba(0,10,10,0.7)] backdrop-blur-md py-2"
                ...
                <div className="container mx-auto px-6 flex justify-between items-center h-16">
                    ...
                    >
                        ...
                        <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-blue-600 font-bold text-xl group-hover:from-blue-300 group-hover:to-blue-500 transition-all duration-300">
                            Bharath Maneel
                        </span>
                    </a>
                    ...
                    >
                        <span className={`w-6 h-[2px] bg-white transition-all ${menuopen ? 'rotate-45 translate-y-[7px]' : ''}`}></span>
                    ...
                    <div className="hidden md:flex items-center space-x-8">
                        ...
                        <a 
                            href="/maneel-portfolio2/resume_maneel.pdf" 
            ...
            <div className={`fixed inset-0 z-30 bg-black/90 backdrop-blur-lg transition-all duration-300 md:hidden ${
                ...
                <div className="flex flex-col items-center justify-center h-full space-y-8">
                    {['home', 'about', 'projects', 'contact'].map((item) => (
                        ...
                        >
                            {item.charAt(0).toUpperCase() + item.slice(1)}
                            <span className={`absolute -bottom-2 left-0 h-[2px] bg-blue-500 transition-all duration-300 ${
                    ...
                    <a 
                        ...
                        className="px-8 py-3 mt-4 bg-blue-600 hover:bg-blue-500 text-white rounded-md transition-all duration-300 font-medium text-lg uppercase tracking-wide"
                        target="_blank"
                        rel="noopener noreferrer"
                    >
                        Resume
