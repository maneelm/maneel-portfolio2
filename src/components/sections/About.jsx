        ...
        <section id="about" className="min-h-screen flex items-center justify-center py-20" aria-labelledby="about-heading">
            <Revealonscroll>
                <div className="max-w-4xl mx-auto px-4">
                    <h2 id="about-heading" className="text-3xl font-bold mb-10 bg-gradient-to-r from-blue-500 to-blue-400 bg-clip-text text-transparent text-center">
                        About Me
                    </h2>
                    ...
                    <article className="rounded-xl p-8 border border-white/10 hover:-translate-y-1 transition-all duration-300 shadow-lg bg-[rgba(15,23,42,0.6)] backdrop-blur-sm mb-8"> 
                        <p className="text-gray-300 mb-8 leading-relaxed text-lg">
                            I'm a full-stack developer with a passion for creating intuitive and responsive web applications. 
                            While I enjoy frontend projects, I also specialize in integrating LLM models to enhance application intelligence and user experience.
                        </p>
                        
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                            <section 
                                className="rounded-xl p-6 bg-blue-950/30 hover:-translate-y-1 transition-all duration-300 shadow-md" 
                                aria-labelledby="frontend-heading"
                            >
                                <h3 id="frontend-heading" className="text-xl font-bold mb-4 text-blue-400">Frontend Skills</h3>
                                <div className="flex flex-wrap gap-2">
                                    {frontendSkills.map((tech, index) => (
                                        <span
                                            key={index}
                                            className="bg-blue-500/10 text-blue-400 py-1 px-3 rounded-full text-sm hover:bg-blue-500/20 hover:shadow-lg hover:shadow-blue-500/20 transition-all cursor-default">
                                            {tech}
                                        </span>
                                    ))}
                                </div>
                            ...
                            >
                                <h3 id="backend-heading" className="text-xl font-bold mb-4 text-green-400">Backend Skills</h3>
                                <div className="flex flex-wrap gap-2">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <div className="p-7 rounded-xl border border-white/10 hover:-translate-y-1 transition-all duration-300 bg-[rgba(15,23,42,0.6)] shadow-md">
                            ...
                            <p className="text-gray-300 leading-relaxed">
                                I believe in building applications that are not only visually appealing but also performant and accessible. 
                                My experience with both frontend and backend technologies allows me to create seamless, end-to-end solutions.
                            </p>
                        </div>
                    </div>
                </div>
